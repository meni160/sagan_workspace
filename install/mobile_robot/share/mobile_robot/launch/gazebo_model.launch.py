...
def generate_launch_description():
    ...
    gazeboLaunch = IncludeLaunchDescription(gazebo_rosPackageLaunch, launch_arguments={"gz_args": [" -r -v -v4 " + os.path.join(get_package_share_directory("mobile_robot"), "worlds/empty_world.sdf")], "on_exit_shutdown": "true"}.items())
